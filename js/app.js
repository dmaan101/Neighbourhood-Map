...
var viewmodel = function() {
    this.availmode = ko.observableArray(['DRIVING',
        'WALKING',
        'BICYCLING',
        'TRANSIT'
    ]);
    ...
    this.inputTimeSearch = ko.observable('');
    var self = this;
    ...
    this.availmins = ko.observableArray(['10',
        '15',
        '30',
        '60'
    ]);
